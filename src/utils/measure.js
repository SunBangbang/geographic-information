...
import { formatLength, formatArea, setToolStyle } from '@/utils/formatMeasure'
import deletePoint from '@/assets/img/delets.png'
import deleteLineArea from '@/assets/img/shanchu.png'
...
function createDom (point, inner, i, coordinates, lengthMeasureCount) {
  console.log(point, inner, i, coordinates, lengthMeasureCount)
