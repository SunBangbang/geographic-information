...
import china from "@/assets/json/zg(3).json"; //中国JSON文件
import water from "@/assets/json/water_c.json"; //waterJSON文件
...
function getLineData(data) {
    ...
    data.forEach(element => {
        result.push({
            // formName: element.startcs,
            // toName: element.endcs,
